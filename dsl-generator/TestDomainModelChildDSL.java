...
public class TestDomainModelChildDSL extends AbstractDSL<TestDomainModelChildDSL, TestDomainModelChild> {
    ...
    private static final Long DEFAULT_MAX_LONG_VALUE = 10L;
    private static final Float DEFAULT_MAX_FLOAT_VALUE = 10.0f;
    private static final long THIRTY_YEARS_IN_MILLS = (long) 1000 * 60 * 60 * 60 * 24 * 30 * 365 * 30;
    private static final Double DEFAULT_MAX_DOUBLE_VALUE = 10.0;
    private static final int DEFAULT_MAX_STRING_LENGTH = 10;
    private static final Integer DEFAULT_MAX_INTEGER_VALUE = 10;
    private static final Short DEFAULT_MAX_SHORT_VALUE = 10;
          
    // members        
    private int intField = RandomUtils.nextInt(0, DEFAULT_MAX_INTEGER_VALUE);
    private double doubleField = RandomUtils.nextDouble(0.0, DEFAULT_MAX_DOUBLE_VALUE);
    private float floatField = RandomUtils.nextFloat(0.0f, DEFAULT_MAX_FLOAT_VALUE);
    private long longField = RandomUtils.nextLong(0, DEFAULT_MAX_LONG_VALUE);
    private short shortField = (short) RandomUtils.nextInt(0, DEFAULT_MAX_SHORT_VALUE);
    private String stringField = RandomStringUtils.randomAlphabetic(DEFAULT_MAX_STRING_LENGTH);
    private Integer integerObjField = RandomUtils.nextInt(0, DEFAULT_MAX_INTEGER_VALUE);
    private Double doubleObjField = RandomUtils.nextDouble(0.0, DEFAULT_MAX_DOUBLE_VALUE);
    private Float floatObjField = RandomUtils.nextFloat(0.0f, DEFAULT_MAX_FLOAT_VALUE);
    private Long longObjField = RandomUtils.nextLong(0, DEFAULT_MAX_LONG_VALUE);
    private Short shortObjField = (short) RandomUtils.nextInt(0, DEFAULT_MAX_SHORT_VALUE);
    private Date dateObjField = new Date(RandomUtils.nextLong(0 ,THIRTY_YEARS_IN_MILLS));
    ...
    private int intFieldP = RandomUtils.nextInt(0, DEFAULT_MAX_INTEGER_VALUE);
    private double doubleFieldP = RandomUtils.nextDouble(0.0, DEFAULT_MAX_DOUBLE_VALUE);
    private float floatFieldP = RandomUtils.nextFloat(0.0f, DEFAULT_MAX_FLOAT_VALUE);
    private long longFieldP = RandomUtils.nextLong(0, DEFAULT_MAX_LONG_VALUE);
    private short shortFieldP = (short) RandomUtils.nextInt(0, DEFAULT_MAX_SHORT_VALUE);
    private String stringFieldP = RandomStringUtils.randomAlphabetic(DEFAULT_MAX_STRING_LENGTH);
    private Integer integerObjFieldP = RandomUtils.nextInt(0, DEFAULT_MAX_INTEGER_VALUE);
    private Double doubleObjFieldP = RandomUtils.nextDouble(0.0, DEFAULT_MAX_DOUBLE_VALUE);
    private Float floatObjFieldP = RandomUtils.nextFloat(0.0f, DEFAULT_MAX_FLOAT_VALUE);
    private Long longObjFieldP = RandomUtils.nextLong(0, DEFAULT_MAX_LONG_VALUE);
    private Short shortObjFieldP = (short) RandomUtils.nextInt(0, DEFAULT_MAX_SHORT_VALUE);
    ...
    public TestDomainModelChild build() {
        ...
        if (this.stringArray == null) {
            ...
            for (int i=0; i < stringArray.length; i++) {
                stringArray[i] = RandomStringUtils.randomAlphabetic(DEFAULT_MAX_STRING_LENGTH);
            }
        ...
        if (this.stringList == null) {
            ...
            for (int i = 0; i < 10; i++) {
                stringList.add(RandomStringUtils.randomAlphabetic(DEFAULT_MAX_STRING_LENGTH));
            }
        ...
        if (this.integerSet == null) {
            ...
            for (int i = 0; i < 10; i++) {
                integerSet.add(RandomUtils.nextInt(0, DEFAULT_MAX_INTEGER_VALUE));
            }
        ...
        if (this.stringCollection == null) {
            ...
            for (int i = 0; i < 10; i++) {
                stringCollection.add(RandomStringUtils.randomAlphabetic(DEFAULT_MAX_STRING_LENGTH));
            }
